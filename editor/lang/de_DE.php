...
$i18n = [
	...
	'name_label' => 'Slug',
	'name_field_infotext' => 'Jede Kombination von Buchstaben (a-z), Zahlen (0-9), Bindestrichen oder Unterstrichen (keine Leerzeichen). Leer lassen, um diese Seite zur Startseite zu machen (nur eine Seite).',
	'error_empty_slug_taken' => 'Nur eine Seite darf einen leeren Slug haben (die Startseite). Eine andere Seite belegt ihn bereits.',
